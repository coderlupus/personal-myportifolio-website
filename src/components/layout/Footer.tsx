        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-end gap-4">
            <div className="flex items-center gap-4">
              ...
              <a href="https://wa.me/5584994121210" target="_blank" rel="noopener noreferrer" className="bg-gray-50 p-2.5 rounded-full text-gray-600 hover:text-white hover:bg-[#25D366] transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-1" aria-label="WhatsApp">
